...
namespace GloomeClasses.src.CollectibleBehaviors {
    ...
    public class HealHackedLocustsBehavior : CollectibleBehavior {

        private HealsHackedProps properties;

        public const string LocustLoverCode = "locustlover";

        public HealHackedLocustsBehavior(CollectibleObject collObj) : base(collObj) {
            properties = new HealsHackedProps();
        }
